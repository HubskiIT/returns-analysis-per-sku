...
- **n8n** — orchestration (20-node workflow, importable JSON in [`n8n-workflows/`](./n8n-workflows/))
...
4. Point the GitHub Issue node at your own repo (or swap it for Slack/Linear/whatever your team actually watches).
5. Watch `flagged_for_review` as a % of total — if it's consistently above ~20%, the prompt needs another eval pass before you trust it unattended.
